...
type SelectTriggerPropsWithShowIcon = React.ComponentPropsWithoutRef<
...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerPropsWithShowIcon
...
type SelectItemPropsWithShowIcon = React.ComponentPropsWithoutRef<
